...
urlpatterns = patterns('',
    ...
    url(r'^(?P<topic_sub>.+)/$', views.topic_view, name='topic'),
    url(r'^(?P<topic_sub>.+)/post/$', views.send_post, name='send_post'),
    url(r'^(?P<topic_sub>.+)/(?P<post_id>\d+)/comment/$', views.send_comment, name='comment'),
